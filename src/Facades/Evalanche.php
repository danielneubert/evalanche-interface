...
class Evalanche
{
    ...
    /**
     * @see Neubert\EvalancheInterface\EvalancheInterface::ATTRIBUTE_TYPES_POOL
     * @var array
     */
    const ATTRIBUTE_TYPES_POOL = EvalancheInterface::ATTRIBUTE_TYPES_POOL;
    ...
    /**
     * Instance (singleton) for static calls.
     *
    ...
    {
        self::$instance = new EvalancheInterface(
            $username,
            $password,
            $host,
            $debug,
